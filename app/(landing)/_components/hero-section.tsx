                ...
                <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:items-center">
                    <div className="text-center lg:text-left">
                        ...
                        <p className="mt-3 text-lg text-slate-600 sm:mt-6">
                            Weekly Capacity (CU) keeps your week realistic.
                            Micro-steps help you recover without starting from
                            zero.
                        </p>
                    ...
                    <div className="relative mx-auto w-full max-w-xl">
                        <div className="absolute -inset-4 rounded-4xl bg-white/70 blur-2xl" />
                            ...
                            <div className="space-y-5 p-6">
                                ...
                                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                                    ...
                                    <p className="mt-2 text-sm text-slate-600">
                                        “Do 2 minutes of your habit today to
                                        keep momentum.”
                                    </p>
                                </div>
                            </div>
