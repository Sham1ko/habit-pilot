...
>(function SetCapacityModal({ initialCapacityCu, plannedCu, onSave }, ref) {
		...
		<Dialog open={open} onOpenChange={handleOpenChange}>
			<DialogContent className="sm:max-w-md">
				<DialogHeader>
					...
					<DialogDescription>
						Define your CU budget for this week. Planning stays marked as
						overloaded when total planned CU exceeds this value.
					</DialogDescription>
				</DialogHeader>
