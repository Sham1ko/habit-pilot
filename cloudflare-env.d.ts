/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: dd8b5f9f80c6b814782a71ccb05eba19)
...
declare namespace Cloudflare {
	interface Env {
		...
		WORKER_SELF_REFERENCE: Fetcher /* habit-pilot */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "JWT_SECRET" | "DATABASE_NAME" | "CLOUDFLARE_D1_DATABASE_ID" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_D1_TOKEN">> {}
}
